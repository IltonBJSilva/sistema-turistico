...
public class ServletTest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Cliente cliente1 = new Cliente(null, "Ilton", "ilton@gmail.com", "32234013", "023303200329",
					sdf.parse("11/12/2001"), new BigDecimal("10.00"));
			Cliente cliente2 = new Cliente(null, "Fabio", "Lucio@gmail.com", "32325023", "094678200329",
					sdf.parse("11/12/2002"), new BigDecimal("50.00"));
